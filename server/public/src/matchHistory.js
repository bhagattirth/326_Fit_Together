...
function createCarousel(pastWorkouts, i){
    ...
    setAttributes(leftButton, {"type":"button", "id":"carouselLeftButton" +i,"data-bs-target":"#carousel"+ i, "data-bs-slide":"prev"});
    ...
    setAttributes(rightButton, {"type":"button", "id":"carouselRightButton" +i,"data-bs-target":"#carousel"+ i, "data-bs-slide":"next"});
	...
	if(workouts.length === 0){
		document.getElementById("carouselRightButton"+i).style.display="none";
		document.getElementById("carouselLeftButton"+i).style.display="none";
	}else{
