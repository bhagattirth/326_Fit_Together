...
async function initialize(id) {
	// If not logged in, state that and provide button link to login page
	// If logged in and profile not found, report as such
	// If logged in and profile found, update each field
